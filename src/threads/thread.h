...
#define INIT_STATUS -10 /* initial current status*/
...
struct thread
{
   ...
   int64_t wakeup;        // used by timer_sleep to wake up thread
   ...
   struct child_process* child_process; // point to child process
